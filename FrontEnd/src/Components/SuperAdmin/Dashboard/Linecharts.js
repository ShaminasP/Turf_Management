...
const LineGraph = ({ data }) => (
    <div className="sm:p-10 w-full mt-10">
        <h3 className="text-violet-100 text-3xl font-bold text-center my-5 pl-8 sm:pl-20">Monthly Earnings</h3>
        <ResponsiveContainer width="100%" height={400}>
            <LineChart data={data} margin={{ top: 20, right: 20, left: 20, bottom: 20 }}>
                <CartesianGrid strokeDasharray="3 3" stroke="#555" />
                <XAxis dataKey="name" tick={{ fontSize: 14, fill: "#ccc" }} tickMargin={10} stroke="#ccc" />
